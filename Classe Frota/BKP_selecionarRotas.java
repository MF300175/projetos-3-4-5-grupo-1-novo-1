...
public class BKP_selecionarRotas {
        ...
        while (opcao != "F") {
            ...
            switch (opcao) {
                ...
                case "4":
                    ...
                    System.out.println("Criar rota nova ou selecionar rota existente?  c||s");
                    if (obj.nextLine().toUpperCase().charAt(0) == 'C') {
                      ...
                      //  virtual.imprimeRotasSemVeiculo();
